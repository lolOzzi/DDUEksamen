class Door extends StaticObject {
   ...
   StopBlock stopBlock;
     ...
     Door(int locX, int locY) {
         ...
         mainDoorSprite = new Sprite("door", loadImage("sprites/game/env/door/door.png"), 1, 7, 10, 0, false);
         lightSprite = new Sprite("doorLight", loadImage("sprites/game/env/door/greenblink.png"), 1, 2, 2, 0);
